...
def pilih():
    zedd = raw_input(G + 'AnonGhost-XSEC ' + R + '\xe2\x96\xb6 ' + W)
    if zedd == '':
        ...
        os.system('clear')
        print ' \033[1;93mRecoded : \033[1;92mMr.$Ud0\n \033[1;93mTeam : \033[1;92mAnonGhost-XSEC \n \033[1;93mFacebook : \033[1;92mhttps://facebook.com/100010777094831 \n\033[1;93m Github : \033[1;92mhttps://www.github.com/mkdirlove '
        print '\n'
        ...
        os.system('clear')
        print G + 'Thanks for using this script. Bye'+N
                        ...
                        if kai == '5':
                            ...
                            if kai == '6':
                                ...
                                if kai == '0':
                                    ...
                                    print '\x1b[1;91m[\xe2\x9c\x96] \x1b[1;97m' + aksi + ' \x1b[1;91mError'
                                    react()
...
def turn():
    g = raw_input(G+'AnonGhost-XSEC'+R+' \xe2\x96\xb6 '+W)
    if g == '1' or g == '01':
        On = 'true'
        gaz(toket, On)
    else:
...
def pilih_super():
    peak = raw_input(G + ' AnonGhost-XSEC\x1b[1;91m >\x1b[1;97m ')
    if peak == '':
        print '\x1b[1;91m[!] Empty command'
        pilih_super()
    elif peak == '1':
